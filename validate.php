<?php
    ...
    if ($result_number && $result_name && $result_email)
    {
        ...
        echo '<p><span class="lyrics">' . json_encode("Been a long time, in a low place/Surrounded by what I have made/Need to get away/Get away from what relates/And what was done…/Cuz it’s all over now/Through the woods, I come running to loose leaf/And carve my name/In the lines, there’s not a trace/I hear the ghost whisper, and those old eyes watching me/But I feel safe…/Grandfather looking over me") . '</span></p>';
    }
    else
    {
        echo '<html>
